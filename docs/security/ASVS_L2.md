...
4. ~~**T-10**: `govulncheck` step in CI.~~ ✅ **Done 2026-05-28** — `.github/workflows/vuln-scan.yaml` (pinned `govulncheck@v1.7.0`, source + binary modes, weekly + push to main + manual dispatch, auto-files / auto-closes a GitHub issue per failing mode). SBOM (CycloneDX) still deferred to Sprint 3.
