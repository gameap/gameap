...
var varsBornWithCurrentName = []string{
	...
	"PLUGINS_AUTOLOAD",
	"PLUGINS_STRICT_LOAD",
	"PLUGINS_ROUTES_TIMEOUT",
	"PLUGINS_ROUTES_QUEUE_TIMEOUT",
	"PLUGINS_ROUTES_MAX_QUEUE",
	"PLUGINS_ROUTES_MAX_INFLIGHT",
	"PLUGINS_ROUTES_MAX_BODY",
	"PLUGINS_ROUTES_MAX_QUERY",
	"PLUGINS_ROUTES_ANONYMOUS",
	"PLUGINS_ROUTES_RATELIMIT_ANON_RPS",
