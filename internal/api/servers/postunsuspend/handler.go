...
func (h *Handler) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	if err := h.suspension.Unsuspend(ctx, &servers[0]); err != nil {
		h.responder.WriteError(ctx, rw, errors.WithMessage(err, "failed to unsuspend server"))
