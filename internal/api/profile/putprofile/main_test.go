...
// using simple literals like "newpassword123" / "validpassword123" without
// tripping the common-password check (auth.ValidatePassword consults the
// package-level blocklist). The policy itself is exercised in
