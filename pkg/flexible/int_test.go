...
func TestInt_UnmarshalJSON(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "integer_at_uint32_boundary",
			jsonStr:  `4294967296`,
			wantErr:  false,
			expected: 4294967296,
		},
		{
			name:     "integer_above_uint32",
			jsonStr:  `8589934592`,
			wantErr:  false,
			expected: 8589934592,
		},
		{
			name:     "string_at_uint32_boundary",
			jsonStr:  `"4294967296"`,
			wantErr:  false,
			expected: 4294967296,
		},
		{
			name:     "string_above_uint32",
			jsonStr:  `"8589934592"`,
			wantErr:  false,
			expected: 8589934592,
		},
...
func Test_anyToInt(t *testing.T) {
	tests := []struct {
		...
		{name: "string_above_uint32", input: "8589934592", expected: 8589934592, wantErr: false},
		{name: "float64_above_uint32", input: float64(8589934592), expected: 8589934592, wantErr: false},
		{name: "int64_above_uint32", input: int64(8589934592), expected: 8589934592, wantErr: false},
		{name: "uint64_above_uint32", input: uint64(8589934592), expected: 8589934592, wantErr: false},
